...
class Query:
    ...
    def __eq__(self, other):
        if isinstance(other, self.__class__):
            ...
            conds = [(col, op, cond.lower() if isinstance(cond, str) else cond) for col, op, cond in
                     self.conditions] == [(col, op, cond.lower() if isinstance(cond, str) else cond) for col, op, cond
                                          in other.conditions]
